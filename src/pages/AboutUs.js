  ...
  return (
    <div className="about-us">
      ...
      <p className="about-description" >
        Welcome to Organic farm! We are dedicated to providing you with the freshest and
        highest quality organic meat and eggs from free-range chickens. Our farm follows the best
        practices to ensure the well-being of our chickens and the sustainability of our
        environment.
      </p>
      <p className="about-description">
        Our mission is to deliver healthy and delicious meat and eggs to your doorstep while
